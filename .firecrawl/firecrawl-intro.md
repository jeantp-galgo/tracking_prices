...
- [firecrawl/firecrawl\\
\\
111,235](https://github.com/firecrawl/firecrawl "firecrawl/firecrawl")
- [firecrawl/firecrawl\\
\\
111,235](https://github.com/firecrawl/firecrawl "firecrawl/firecrawl")
...
- [Get started](https://docs.firecrawl.dev/introduction#get-started)
...
- [Scrape](https://docs.firecrawl.dev/introduction#scrape)
- [Interact](https://docs.firecrawl.dev/introduction#interact)
- [More capabilities](https://docs.firecrawl.dev/introduction#more-capabilities)
...
[**Get your API key** \\
\\
Sign up and get your API key to start using Firecrawl](https://www.firecrawl.dev/app/api-keys)
...
[**Interact** \\
\\
Continue working with any scraped page — click, fill forms, extract dynamic content](https://docs.firecrawl.dev/introduction#interact)
...
[Skill + CLI\\
\\
Next](https://docs.firecrawl.dev/sdks/cli)\
\
Ctrl+I\
\
